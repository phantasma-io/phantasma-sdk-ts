 ...
 * expectedGasBill is the exact settled bill. Throws when wouldAbort is set, because an aborted
 * simulation has no recommendations. Retry with a higher offer, or fall back to the Tier-1
 * estimator.
 */
